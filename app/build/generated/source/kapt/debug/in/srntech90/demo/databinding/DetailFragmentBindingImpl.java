...
public class DetailFragmentBindingImpl extends DetailFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.relUpperLayout, 3);
        sViewsWithIds.put(R.id.imgDetail, 4);
        sViewsWithIds.put(R.id.txtMovieName, 5);
        sViewsWithIds.put(R.id.txtYears, 6);
    }
    // views
    @NonNull
